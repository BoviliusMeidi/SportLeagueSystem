<header class="bg-primary-300 text-text-300 py-5 px-6 flex justify-between items-center">
    ...
    <div class="flex-row items-center px-8">
        <form action="{{ route('search') }}" method="GET" class="rounded-full bg-primary-100  w-screen max-w-md flex items-center">
    ...
    <div class="flex items-center px-8 mx-4 text-xl text-text-100">
        ...
        <a href="{{ route('team') }}" class="flex items-center">
            <h2 class="px-4 py-2 bg-primary-100 hover:bg-primary-200 hover:text-text-300 rounded-full mr-4">Team</h2>
        </a>
        ...
        <a href="{{ route('venue') }}" class="flex items-center">
        ...
        <div class="cursor-pointer" id="theme-toggle">
            <span
                class="material-symbols-sharp bg-primary-100 hover:bg-primary-200 hover:text-text-300 rounded-full py-2 px-2 mr-4"
                id="theme-icon">
            </span>
        </div>
        <div class="">
            @if (Request::is('homepage'))
                <a href="{{ route('register') }}">
                    <span
                        class="material-symbols-sharp bg-primary-100 hover:bg-primary-200 hover:text-text-300 rounded-full py-2 px-2">
                        account_circle
                    </span>
                </a>
            @else
