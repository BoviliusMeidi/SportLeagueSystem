<header class="bg-primary-300 text-text-300 py-5 px-6 flex justify-between items-center">
    <div class="flex-row items-center px-8">
        <a href="" class="flex items-center">
            <span class="material-symbols-sharp bg-primary-100 text-text-100 rounded-full py-2 px-2 mr-5">
                sports_soccer
            </span>
            <h2 class="text-2xl">SportLeagueSystem</h2>
        </a>
    </div>
    <div class="flex-row items-center px-8">
    ...
    <div class="flex items-center px-8 mx-4 text-xl text-text-100">
        ...
        <a href="" class="flex items-center">
            <h2 class="px-4 py-2 bg-primary-100 hover:bg-primary-200 hover:text-text-300 rounded-full mx-4">League</h2>
        </a>
        <a href="" class="flex items-center">
            <h2 class="px-4 py-2 bg-primary-100 hover:bg-primary-200 hover:text-text-300 rounded-full mx-4">Venue</h2>
        </a>
    </div>
</header>
