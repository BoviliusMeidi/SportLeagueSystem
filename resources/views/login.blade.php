...
<body class="bg-primary-100 w-full h-full flex justify-center">
    <main class="text-text-100 flex min-h-full flex-col justify-center w-2/3 px-6 py-12">
        <div class="flex flex-col items-center">
            ...
            <h2 class="text-center text-3xl py-2">Login your account</h2>
        </div>
        <div class="flex flex-col items-center justify-center ">
            <form class="space-y-6 w-full max-w-md" action="{{ route('login.post') }}" method="POST">
                @csrf
                <div>
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-primary-200 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary-300 hover:text-text-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-300">Login
                        account</button>
                </div>
            ...
            <p class="mt-10 text-center text-sm">
              ...
              <a href="register" class="font-semibold leading-6 text-text-100 hover:underline">Create an Account</a>
            </p>
        </div>
    </main>
</body>
